...
export const HeaderSection = styled.header`
  ...
  box-shadow: ${({ scroll }) =>
    scroll ? "0 1px 0.625rem rgba(5, 16, 32, 1)" : ""};
...
export const Line = styled.span`
  ...
  transition: all 0.2s cubic-bezier(0.8, 0.2, 0.7, 1.3),
    width 0.2s 0.1s cubic-bezier(0.7, 0.2, 0.7, 1.4);
  ...
  &:nth-child(1) {
    transform: ${({ toggleNav }) =>
      toggleNav ? "translateY(0.6875rem) rotate(-45deg)" : ""};
  }
  &:nth-child(2) {
